package com.longbei.lwebview.wegit;
...
public class BottomBar extends View {
    ...
    private SwitcnListener switcnListener;
    ...
    public interface SwitcnListener{
        void onSwitcn(int currentCheckedIndex);
    }

    public void setOnSwitcnListener(SwitcnListener switcnListener){
        this.switcnListener = switcnListener;
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP :
                ...
                if (target == withinWhichArea((int)event.getX())) {
                    ...
                    invalidate();
                    if(switcnListener!=null)
                        switcnListener.onSwitcn(currentCheckedIndex);
                }
                target = -1;
                break;
        }
