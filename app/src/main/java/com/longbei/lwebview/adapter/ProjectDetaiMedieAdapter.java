...
public class ProjectDetaiMedieAdapter extends BaseQuickAdapter<TypeBean, BaseViewHolder> {
    public ProjectDetaiMedieAdapter(int layoutResId, @Nullable List<TypeBean> data) {
